...
type CodeEditorProps = {
  ...
  onChange: <Key extends keyof PlaygroundConfig>(
    key: Key,
...
export function CodeEditor({ code, config, onChange }: CodeEditorProps) {
    ...
    <section className={styles.editor} aria-label="Interactive API configuration">
      ...
      <FieldGroup className={styles.code} aria-label="QR code options">
        <CodeLine number={1}>
          ...
          <span className={styles.typeName}>QRSvg</span>
        ...
        <CodeLine number={5} indent={1}>
          ...
          <Field className={styles.inlineField}>
            ...
            <Select
              ...
              value={config.ecl}
              onValueChange={(value) =>
                value && onChange('ecl', value as ErrorCorrectionLevel)
              }
            >
        ...
        <CodeLine number={16} indent={1}>{'}'},</CodeLine>
        ...
        <CodeLine number={19} indent={1}>{'}'},</CodeLine>
